...
// Source: ./internal/domain/service/websocket_manager.go
//
// Generated by this command:
//
//	mockgen -source=./internal/domain/service/websocket_manager.go -destination=./mocks/service/websocket_manager_mock.go
//
...
func (m *MockWebSocketConnection) WriteMessage(arg0 []byte) error {
	m.ctrl.T.Helper()
...
func (m *MockWebsocketManager) RegisterID(conn service.WebSocketConnection, id string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "RegisterID", conn, id)
}
